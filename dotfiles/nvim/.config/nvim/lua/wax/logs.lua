...
---@class Wax.Log
---@field trace function(...: any): string
---@field debug function(...: any): string
---@field info function(...: any): string
---@field warn function(...: any): string
---@field error function(...: any): string
